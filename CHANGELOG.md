...
다음 릴리스 v1.5.0에 묶인다(마일스톤 v1.5.0). 릴리스는 작업마다 내지 않고 한 이야기로 묶이는 범위에서 한 번 낸다 —
UX 1차·UX 2차와 이번 주 결함 수정, 알려진 기술 과제 넷(실행계획 가림·샘플러 기록 시각·MCP 토큰 범위·SQL Server 드라이버)이
끝나면 태그를 친다. 그 사이 보안·데이터 손상 결함만 패치 버전으로 낸다.

지금까지 들어온 것은 두 묶음이다. 실제 화면 점검에서 나온 UI/UX 문제(184절, #40 → #42~#49, PR #50~#54)와,
그 뒤 UX 2차의 첫 작업·촬영 중 찾은 결함(185~189절, #55·#56·#61·#69·#70·#72·#73).
...
[Unreleased]: https://github.com/dj258255/dbtower/compare/v1.4.0...HEAD
