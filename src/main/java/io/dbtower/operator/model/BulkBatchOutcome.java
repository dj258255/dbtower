 ...
 * 취소·실패가 커밋된 배치를 되돌리지 않으므로(docs/bulk-change-spec.md), 마지막 키가 곧 재개 지점이자 사람이
 * 백업 복원을 판단할 자리다.
 *
 * @param fromKey       이 배치가 연 구간의 하한(첫 배치는 null — 하한 없이 시작한다)
 ...
 */
public record BulkBatchOutcome(Object fromKey, Object toKey, long affectedRows, long elapsedMillis) {
}
