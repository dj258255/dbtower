...
3. [설계 문서](DESIGN.md)에서 모듈 경계와 핵심 결정을 읽습니다.

전체 발표 서사가 필요하면 [PRESENTATION.md](PRESENTATION.md), 면접 관점의 짧은 답이
필요하면 [INTERVIEW-QA.md](INTERVIEW-QA.md)를 사용합니다.
...
| [architecture-detail.svg](architecture-detail.svg) | 채널, 모듈, 외부 의존을 한 장으로 본 구조도 |
| [erd.svg](erd.svg) | 메타 DB 핵심 테이블 관계 |
...
| [INTERVIEW-QA.md](INTERVIEW-QA.md) | 설계·안전·검증에 관한 예상 질문과 답 |
...
| 목적 | 권장 순서 |
|---|---|
| 빠르게 평가 | 한 장 요약 -> 5분 시연 -> 검증 기록의 연결된 절 |
