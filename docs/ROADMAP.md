...
| 4+ | 보여주기와 회귀 고정: 데모 compose PostgreSQL = postgres:16 + HypoPG, 대시보드 인덱스 제안이 정규화 텍스트($1·$2)에서 502이던 결함(GENERIC_PLAN 경로로 수정, Total Cost 12578.73 -> 8.47), 역할별 화면 E2E(Playwright, CI), 데모 GIF·한 장 요약·면접 질문 | 137절 |
